...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        int colorInstance = ColorUtils.getViewHolderBackgroundColorFromInstance(context, viewHolderCount);

        // COMPLETED (14) Set the background color of viewHolder.itemView with the color from above
        viewHolder.itemView.setBackgroundColor(colorInstance);

        // COMPLETED (15) Increment viewHolderCount and log its value
        Log.d(TAG,"View Holder count-> "+viewHolderCount);
        viewHolderCount += 1;
        return viewHolder;
    }
